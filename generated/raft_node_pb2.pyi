...
class LogEntry(_message.Message):
    __slots__ = ("term", "index", "command_type", "command_data")
    TERM_FIELD_NUMBER: _ClassVar[int]
    ...
    command_type: str
    command_data: str
    def __init__(self, term: _Optional[int] = ..., index: _Optional[int] = ..., command_type: _Optional[str] = ..., command_data: _Optional[str] = ...) -> None: ...
...
class LeaderInfoResponse(_message.Message):
    __slots__ = ("is_leader", "leader_id", "leader_address", "current_term", "state")
    ...
    current_term: int
    state: str
    def __init__(self, is_leader: bool = ..., leader_id: _Optional[int] = ..., leader_address: _Optional[str] = ..., current_term: _Optional[int] = ..., state: _Optional[str] = ...) -> None: ...
