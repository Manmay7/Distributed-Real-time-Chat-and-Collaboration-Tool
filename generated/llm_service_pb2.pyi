...
class SmartReplyRequest(_message.Message):
    ...
    request_id: str
    recent_messages: _containers.RepeatedCompositeFieldContainer[Message]
    user_id: str
    def __init__(self, request_id: _Optional[str] = ..., recent_messages: _Optional[_Iterable[_Union[Message, _Mapping]]] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class SummarizeRequest(_message.Message):
    ...
    max_length: int
    def __init__(self, request_id: _Optional[str] = ..., messages: _Optional[_Iterable[_Union[Message, _Mapping]]] = ..., max_length: _Optional[int] = ...) -> None: ...
...
class ContextRequest(_message.Message):
    ...
    request_id: str
    context: _containers.RepeatedCompositeFieldContainer[Message]
    current_input: str
    def __init__(self, request_id: _Optional[str] = ..., context: _Optional[_Iterable[_Union[Message, _Mapping]]] = ..., current_input: _Optional[str] = ...) -> None: ...
